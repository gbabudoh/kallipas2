...
export default function Hero({ settings }: { settings: GlobalSiteSettings }) {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-[#F2EAE0]/30 min-h-screen flex items-center">
      ...
      <div className="absolute top-[20%] right-[10%] w-[20%] h-[20%] bg-[#9AB17A]/10 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            className="text-left"
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 border border-[#9AB17A]/20 text-[#9AB17A] text-xs font-bold mb-6 shadow-sm backdrop-blur-md uppercase tracking-wider">
            ...
            <div className="relative group max-w-2xl">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#9AB17A] to-[#C3CC9B] rounded-[2rem] blur opacity-20 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
              <div className="relative flex flex-col md:flex-row items-center gap-2 p-2 bg-white/70 backdrop-blur-2xl border border-white/80 rounded-[2rem] shadow-xl">
                ...
                <button className="w-full md:w-auto px-8 py-4 bg-[#9AB17A] hover:bg-[#88a068] text-white font-bold text-lg rounded-[1.5rem] transition-all flex items-center justify-center gap-2 group/btn">
                  Search
            ...
            <div className="mt-12 flex flex-wrap gap-4">
              {[
                ...
                >
                  <item.icon className="w-4 h-4 text-[#9AB17A]" />
          ...
          >
            ...
            <div className="relative z-10 p-4 bg-white/40 backdrop-blur-md rounded-[3rem] border border-white/60 shadow-2xl overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-tr from-[#9AB17A]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            ...
            <motion.div 
              ...
              className="absolute -top-6 -left-6 p-4 bg-[#9AB17A] text-white rounded-2xl shadow-xl z-20 flex flex-col items-center"
            >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#E8F5BD] flex items-center justify-center">
                  <Search className="w-5 h-5 text-[#9AB17A]" />
                </div>
                <div>
